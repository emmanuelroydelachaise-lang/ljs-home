const CACHE = 'ljs-home-v10';
const ASSETS = [
  './', './index.html', './styles.css', './print-vector.css', './print-fit.css', './admin-archives.css', './admin-dashboard.css', './technician-admin-changes.css', './technician-archives.css', './leave-requests.css', './admin-leave-requests.css', './config.js', './hidden-admin-access.js', './home-supabase-router.js',
